      ...
      <main className="flex-grow max-w-7xl w-full mx-auto p-4 md:p-6 flex flex-col gap-6">
        ...
        {activeTab === "consultar" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
            ...
            {/* COLUMNA IZQUIERDA: LECTOR Y NUMPAD */}
            ...
            {/* COLUMNA CENTRAL: RESULTADO DE ESCANEO Y HISTORIAL */}
            <section className="lg:col-span-4 flex flex-col gap-6" id="panel-resultados">
              
              {/* COMPONENT CARGANDO / VACIO */}
              {!currentScannedProduct ? (
                <div id="result-empty" className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex-grow flex flex-col items-center justify-center text-center gap-4 min-h-[300px]">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1 max-w-[240px] mx-auto">
                      Presioná un producto abajo en el banco de pruebas interactivo, o ingresá un código en el teclado numérico.
                    </p>
                  </div>
                </div>
              ) : (
                /* TARGETA DE PRODUCTO ESCANEADO */
